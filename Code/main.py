...
class Menu:
    ...
    def __init__(self, board_width, board_height):
        ...
        self.keyboard_buttons = [Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_1_button_start_position[0] + setti.keyboard_button_width + setti.keyboard_gap*screen_size_factor, self.user_1_button_start_position[1], setti.keyboard_button_image, text="W"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_1_button_start_position[0], self.user_1_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="A"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_1_button_start_position[0] + setti.keyboard_button_width + setti.keyboard_gap*screen_size_factor, self.user_1_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="S"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_1_button_start_position[0] + 2*setti.keyboard_button_width + 2*setti.keyboard_gap*screen_size_factor, self.user_1_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="D"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_1_button_start_position[0] + 4*setti.keyboard_button_width + 4*setti.keyboard_gap*screen_size_factor, self.user_1_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="C"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_1_button_start_position[0] + 5*setti.keyboard_button_width + 5*setti.keyboard_gap*screen_size_factor, self.user_1_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="V"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_1_button_start_position[0] + 6*setti.keyboard_button_width + 6*setti.keyboard_gap*screen_size_factor, self.user_1_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="B"),

                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_2_button_start_position[0] + setti.keyboard_button_width + setti.keyboard_gap*screen_size_factor, self.user_2_button_start_position[1], setti.keyboard_button_image, text="↑"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_2_button_start_position[0], self.user_2_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="←"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_2_button_start_position[0] + setti.keyboard_button_width + setti.keyboard_gap*screen_size_factor, self.user_2_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="↓"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_2_button_start_position[0] + 2*setti.keyboard_button_width + 2*setti.keyboard_gap*screen_size_factor, self.user_2_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="→"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_2_button_start_position[0] + 4*setti.keyboard_button_width + 4*setti.keyboard_gap*screen_size_factor, self.user_2_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="I"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_2_button_start_position[0] + 5*setti.keyboard_button_width + 5*setti.keyboard_gap*screen_size_factor, self.user_2_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="O"),
                                 Button(setti.keyboard_button_width, setti.keyboard_button_height, self.user_2_button_start_position[0] + 6*setti.keyboard_button_width + 6*setti.keyboard_gap*screen_size_factor, self.user_2_button_start_position[1] + setti.keyboard_button_height + setti.keyboard_gap*screen_size_factor, setti.keyboard_button_image, text="P")
                                 ]
    ...
    def draw(self):
        ...
        for button in self.keyboard_buttons:
            button.draw()
        screen.blit(pg.transform.scale(self.user_1_character['image'], (self.user_1_character['width'], self.user_1_character['height'])), (self.x_offset + 0.25*self.width - self.user_1_character['width']/2, self.y_offset + 0.3*self.height - self.user_1_character['height'] + setti.arrow_button_height))
        screen.blit(pg.transform.scale(self.user_2_character['image'], (self.user_2_character['width'], self.user_2_character['height'])), (self.x_offset + 0.75*self.width - self.user_2_character['width']/2, self.y_offset + 0.3*self.height - self.user_2_character['height'] + setti.arrow_button_height))
